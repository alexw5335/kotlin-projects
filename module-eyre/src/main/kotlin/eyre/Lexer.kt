...
class Lexer(private val file: SrcFile) {


	private val chars = file.text
	...
	fun lex(): LexOutput {
		...
		return LexOutput(file, tokens, newlines)
	}
	...
	private fun idStart() {
		...
		tokens.add(IdToken(Interning.addOrGet(String(chars, startPos, pos - startPos))))
	}
