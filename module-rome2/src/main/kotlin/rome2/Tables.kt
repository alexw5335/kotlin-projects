...
class Table(val name: String, val num: Int, val keys: String) {
	fun secondLine(prefix: String) = "#${name}_tables;$num;db/${name}_tables/${prefix}_$name"
