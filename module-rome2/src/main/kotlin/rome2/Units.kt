...
object Units {
	...
	val AUX_AFRICAN_ELEPHANT = unit("Aux_Afr_Elephant")
	val AUX_GALLIC_HUNTERS = unit("Aux_Gal_Gallic_Hunters")
	val AUX_LONGBOW_HUNTERS = unit("Aux_Ger_Longbow_Hunters")
	val AUX_PELTASTS = unit("Aux_Gre_Peltasts")
	val AUX_CRETAN_ARCHERS = unit("Aux_Gre_Cretan_Archers")
