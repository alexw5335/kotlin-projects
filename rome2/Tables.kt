...
object Tables {
	...
	val GARRISON_GROUP_UNITS = table("armed_citizenry_units_to_unit_groups_junctions")
	val GARRISON_GROUPS = table("armed_citizenry_unit_groups")
	val TECH_UNIT_UPGRADES = table("technology_unit_upgrades")
	val EXPERIENCE_TIERS = table("character_experience_skill_tiers")
	val SKILLS = table("character_skills")
	val SKILL_LEVELS = table("character_skill_level_details")
	val SKILL_EFFECTS = table("character_skill_level_to_effects_junctions")
